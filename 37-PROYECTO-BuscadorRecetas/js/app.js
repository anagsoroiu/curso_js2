function iniciarApp(){
    ...
    favoritosDiv = document.querySelector('.favoritos');
    ...
    function mostrarRecetas(recetas = []){
        ...
        recetas.forEach(receta =>{
            const {idMeal, strMeal, strMealThumb} = receta,
                  recetaContenedor = document.createElement('div'),
                  recetaCard = document.createElement('div'),
                  recetaImagen = document.createElement('img'),
                  recetaCardBody = document.createElement('div'),
                  recetaHeading = document.createElement('h3'),
                  recetaButton = document.createElement('button');
        ...
        for(let i = 1; i <= 20; i++){
            if(receta[`strIngredient${i}`]){
                const ingrediente = receta[`strIngredient${i}`],
                      ...
                      ingredienteLi = document.createElement('li');
